...
%                    |6a7956eb0efe3c11c9b4a9d8ec8ae69c|
...
%% Vraag 6
%
% Stelling 1:   de size van een vector v=[ 3 3 3 3] is 1 bij 3
%
% Stelling 2:   van de vector v=[ 7 1 2 9] krijg je bij de aanroep v(2:end) de waardes 2 3 4
%
