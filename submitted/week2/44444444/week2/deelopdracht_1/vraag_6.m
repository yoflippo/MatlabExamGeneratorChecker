...
%                    |f1abdc106b405018c239c571c48b8683|
...
%% Vraag 6
%
% Stelling 1:   van een vector: v=[ 7 8 2 1] krijg je bij de aanroep v(1) de waarde 7
%
% Stelling 2:   van de vector v=[ 7 1 2 9] krijg je bij de aanroep v(2:end) de waardes 1 2 9
%
...
% vraag_6_ANTWOORD.m voor de oplossing\uitwerking.
