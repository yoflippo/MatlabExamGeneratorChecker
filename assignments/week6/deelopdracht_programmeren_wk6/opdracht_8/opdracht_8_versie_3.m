...
%                    |4ec135c68b89afaac36ba13e9feb93db|
%                            1811231301
%
...
% speler de bal niet vast heeft en de bal naar voren beweegt. Zo'n tijdstip 
% wordt gedefinieerd als een tijdstip i waarbij de positie op het volgende 
% tijdstip i+1 groter is dan op tijdstip i. Op tijdstip i en op
% i+1 moet hij de bal vast hebben. 
% 
% Dus, geef een logical vector met de 
% naam 'vastNaarVoren' die enen bevat op de tijdstippen waarop de speler 
% met de bal naar voren loopt en nullen als hij naar achter loopt of 
% niemand de bal vast heeft.
