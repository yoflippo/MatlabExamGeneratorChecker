...
%                    |46ba3ab0a1b26685205d0e9b4b24611b|
%                            1811231301
%
...
% naar voren rent. Zo'n tijdstip wordt gedefinieerd als een tijdstip i 
% waarbij de positie op het volgende tijdstip i+1 groter is dan op tijdstip 
% i. Op tijdstip i en op i+1 moet hij de bal vast hebben. 
% 
% Dus, geef een logical vector met de naam  'vastNaarVoren' die enen bevat 
% op de tijdstippen waarop de speler met de bal naar voren loopt en nullen 
