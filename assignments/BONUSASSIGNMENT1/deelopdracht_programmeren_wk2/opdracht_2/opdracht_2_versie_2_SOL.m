...
%                    |1359eabefe6800ea51fedb8c9b73965e|
%                            1811231654
%
...
%% Opdracht 2
% Maak een functie die een getal tot de derde macht uitrekent.
% 
% Die functie heet: 'opdracht_2' (zie hieronder) en heeft een input genaamd
% 'getal'. Geef de output de naam 'result'.
% Een function file mag enkel en alleen een functie bevatten. 
function result = opdracht_2(getal)
