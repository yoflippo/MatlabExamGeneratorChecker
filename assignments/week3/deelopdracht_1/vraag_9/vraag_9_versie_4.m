...
%                    |84eb74571e0f320854b636ccd9fef1e6|
%                            1711051801
%
...
%% Vraag 9
%
% Stelling 1:   De onderstaande code wordt 10 x herhaald door de while-lus:
%				                                                           
%				======= Code =======                                       
%				                                                           
%				blTest = false;                                            
%				teller = 0;                                                
%				while teller < 0 && blTest == false                        
%				    disp(num2str(teller));                                 
%				    teller = teller + 1;                                   
%				end                                                        
%				                                                           
...
%				                                                           
%
% Stelling 2:   De while-lus blijft zichzelf herhalen zolang de expressie true is.
%
