...
%                    |a5745915f558de4ec68c6aa3ccf2d17d|
%                            1811231301
%
...
% Let op! Bij het oplossen mag je geen variabele verwijderen of 
% index veranderen. Fstuw moet de waarde 'hoog' krijgen.

autoSnelheid= 1:3:91;
if autoSnelheid(5)== 8
    Fstuw = 4;
elseif autoSnelhed(31)= 91; 
    Fstuw= 'hoog;
end
