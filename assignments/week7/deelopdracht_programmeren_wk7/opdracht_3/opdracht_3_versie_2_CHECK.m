...
checkingVar.nameVars = {'honkbalVersnelling'};
checkingVar.literalsP = {'maximaleVersnelling = max(honkbalVersnelling)' 1 'indexMaximaleVersnelling = honkbalVersnelling(find(maximaleVersnelling))' 1};
