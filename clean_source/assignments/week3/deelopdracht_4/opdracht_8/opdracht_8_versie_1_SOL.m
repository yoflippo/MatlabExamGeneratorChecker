...
% speler de bal vast heeft en naar achter rent.
% Zo'n tijdstip wordt gedefinieerd als een tijdstip i
% waarbij de positie op het volgende tijdstip i+1
% kleiner is dan op tijdstip i. Op tijdstip i en op
% i+1 moet hij de bal vast hebben. Dus, geef een logical
% vector met de naam vastNaarAchter die enen bevat op de
% tijdstippen waarop de speler met de bal naar achter
% loopt en nullen als hij naar voren loopt of niemand
% de bal vast heeft.
...
vastNaarAchter = (balVast2 == 1 & naarAchter ==1) 
