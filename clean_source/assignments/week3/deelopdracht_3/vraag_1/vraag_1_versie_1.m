%% Vraag 1
%
% Stelling 1:   Een vector bestaande uit logicals kan de waarde 2 bevatten.
%
% Stelling 2:   Een vector bestaande uit logicals kan niet worden         
%				worden gebruikt om elementen van een vector te selecteren.
%
