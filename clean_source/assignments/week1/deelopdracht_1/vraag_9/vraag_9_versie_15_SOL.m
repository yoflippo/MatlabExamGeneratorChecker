%% Vraag 9
%
% Stelling 1:   Met de colon-operator kan een oplopende numerieke
%				vector worden aangemaakt. Dat kan op de volgende 
%				manier: 10:-1:10.                                
%
% Stelling 2:   Met de onderstaande code zeg je tegen Matlab
