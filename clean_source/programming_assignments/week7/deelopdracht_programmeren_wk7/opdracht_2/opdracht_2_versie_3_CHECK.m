...
checkingVar.nameVars = {'tangentieleVersnelling'};
checkingVar.literalsP = {' t = 1:0.01:10;' 1 'if length(hoekKogelSlingeraar)== length(t)' 1 ...
   'hoekKogelSlingeraar(1) == 6.44' 1 ' tangentieleVersnelling=5; ' 1  };
