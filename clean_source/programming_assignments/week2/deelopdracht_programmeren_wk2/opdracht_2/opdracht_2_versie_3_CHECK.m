function res = opdracht2_versie_2_CHECK(apStudentSol)
...
checkingVar.testFunctionInput.data = {{round(randn(1,1)*10)} {round(randn(1,1)*10)} ...
    {round(randn(1,1)*10)} {round(randn(1,1)*10)} {0} {1} {-1} {1000} {-2222}};
