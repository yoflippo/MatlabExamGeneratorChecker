function GiveHashesToAssignments(con,DEBUGOUTPUT)

%GIVEHASHESTOASSIGNMENTS
...
apCurrBonusAss = fullfile(con.BASEFOLDER,con.NAMEASSIGNMENTFOLDER,nmCurrBonusAss);
...
try
    ...
    error([mfilename ', ' newline ',' causeException.message]);
end
