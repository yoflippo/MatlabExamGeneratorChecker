...
chr = [chr newline ];
chr = [chr newline 'De deadline van deze bonusopdracht is 13-01-20 om 16:59h.'];
chr = [chr newline ];
...
chr = [chr newline ];
chr = [chr newline 'Wij proberen jouw opdracht na het inlevermoment, binnen 15 werkdagen na te kijken. Je ontvangt je nagekeken werk op dit e-mailadres.'];
