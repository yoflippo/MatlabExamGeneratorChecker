function res = literalAnswersThisOrThatAndRev(txtns,literalsRO,apStudentSol)
...
for nO = 1:length(literalsRO)
    lit = literalsRO{nO};
    lLit = length(literalsRO{nO});
    if mod(lLit,2)
        error([mfilename ': The literalsRO have to be even!!' ]);
    end
